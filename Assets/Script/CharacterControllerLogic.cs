...
public class CharacterControllerLogic : MonoBehaviour 
{
	...
	private ThirdPerson_Camera gamecam;
	[SerializeField]
	...
	[SerializeField]
	private NavMeshAgent capCollider;
	[SerializeField]
	...
	void Start() 
	{
		gamecam = cam.GetComponent<ThirdPerson_Camera>();
		animator = GetComponent<Animator>();
		capCollider = GetComponent<NavMeshAgent>();
	...
	void Update() 
	{
		if (animator && gamecam.CamState != ThirdPerson_Camera.CamStates.FirstPerson)
		{
	...
	{							
		...
		if (IsInLocomotion() && gamecam.CamState != ThirdPerson_Camera.CamStates.Free && !IsInPivot() && ((direction >= 0 && leftX >= 0) || (direction < 0 && leftX < 0)))
		{
		...
		/*if (IsInJump())
		{
			...
			if (gamecam.CamState != ThirdPerson_Camera.CamStates.Free)
			{
